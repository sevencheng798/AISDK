...
#ifndef __SPEECHSYNTHESIZER_OBSERVER_INTERFACE_H_
#define __SPEECHSYNTHESIZER_OBSERVER_INTERFACE_H_
#include <iostream>
...
public:
    ...
    enum class SpeechSynthesizerState {
        ...
        /// In this state, the @c SpeechSynthesizer is gaining the channel trace while still not playing anything
        GAINING_FOCUS,

        /// In this state, the @c SpeechSynthesizer is losing the channel trace but not yet considered @c FINISHED
        LOSING_FOCUS
    };
...
#endif 	//__SPEECHSYNTHESIZER_OBSERVER_INTERFACE_H_
