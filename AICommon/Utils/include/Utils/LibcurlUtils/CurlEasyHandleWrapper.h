...
#ifndef _LIBCURLUTILS_CURL_EASYHANDLE_WRAPPER_H_
#define _LIBCURLUTILS_CURL_EASYHANDLE_WRAPPER_H_
...
private:
	...
	/*
	 * Prepare a CURL handle to requires TLS ca. 
...
bool CurlEasyHandleWrapper::setopt(CURLoption option, ParamType value) {
    ...
    if (result != CURLE_OK) {
		#if 0 //Sven
        logging::acsdkError(logging::LogEntry("CurlEasyHandleWrapper", "setoptFailed")
...
#endif  // _LIBCURLUTILS_CURL_EASYHANDLE_WRAPPER_H_
