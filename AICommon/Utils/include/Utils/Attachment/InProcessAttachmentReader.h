...
#ifndef __UTILS_ATTACHMENT_INPROCESSATTACHMENTREADER_H_
#define __UTILS_ATTACHMENT_INPROCESSATTACHMENTREADER_H_
...
public:
    ...
    using SDSTypeIndex = utils::sharedbuffer::SharedBuffer::Index;
    using SDSTypeReader = utils::sharedbuffer::Reader;
     ...
     * @param index If being constructed from an existing @c SharedBuffer, the index indicates where to read from.
...
#endif  // __UTILS_ATTACHMENT_INPROCESSATTACHMENTREADER_H_